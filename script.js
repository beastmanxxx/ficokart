    ...
    orderItems.forEach(item => {
        ...
        itemsHTML += `
            <tr>
                ...
                <td style="padding: 8px; border-bottom: 1px solid #eee; text-align: center; font-size: 13px;">${formatCurrency(itemPrice)}</td>
                <td style="padding: 8px; border-bottom: 1px solid #eee; text-align: center; font-size: 13px;">${itemQuantity}</td>
                <td style="padding: 8px; border-bottom: 1px solid #eee; text-align: right; font-weight: 600; font-size: 13px; color: #27ae60;">${formatCurrency(itemTotal)}</td>
            </tr>
        `;
    });
