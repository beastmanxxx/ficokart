...
function updateBannerForSubcategory(subcategoryName) {
    ...
    const isSubcategorySelected = subcategoryName && subcategoryName !== 'All Products';
    let slideImages = [];
...
window.openProductModalFromRelated = function(productId) {
    ...
    if (allImages.length > 1) {
        ...
        // Single image - show normally
        const fallbackImg = variantImage || product.imageUrl;
        carouselHTML = `<img src="${fallbackImg}" alt="${variantName}" class="product-modal-image" onerror="this.src='data:image/svg+xml;base64,'">`;
    }
