...
window.openProductModal = function (productId) {
    ...
    if (allImages.length > 1 || hasColors) {
        ...
        carouselHTML = `<img id="productPrimaryImage-${product.id}" data-default-src="${product.imageUrl}" src="${product.imageUrl}" alt="${product.name}" class="product-modal-image" onerror="this.src='data:image/svg+xml;base64,'">`;
    }
