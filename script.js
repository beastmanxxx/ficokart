...
window.openConfirmOrderModal = async function (productId) {
    ...
    if (window.orderFromCart && window.orderFromCart.productId === productId) {
        ...
        // Check if it's a custom pricing option (treat like weight-based: base price here, common discount below)
        ...
        // Apply main discount if available (same as weight-based behavior)
