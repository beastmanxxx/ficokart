    ...
    try {
        ...
        if (userId && totalAmount > 0) {
            ...
            if (currentUser && currentUser.uid === userId) {
                ...
                setTimeout(() => {
                    showNotification(`🎉 Great news! ${formatCurrency(totalAmount)} has been added to your cashback wallet!`, 'success');
                }, 2000);
            }
        }
        ...
        showNotification(`Refund completed! ${formatCurrency(totalAmount)} added to customer's cashback wallet ✅`, 'success');
