...
async function notifyAdminsByEmail(orderData) {
    try {
        ...
        console.log(`📨 Found ${adminEmails.length} admins. Notifying production backend on Render...`);

        // 3. Send to our Production Node.js Backend Server on Render
    ...
    colorGroup.innerHTML = `
        ...
        <div class="color-images-container" style="padding: 10px; background: #f8f9fa; border-radius: 5px;">
            ...
            <div class="color-image-inputs">
                <input type="url" class="color-image-url" placeholder="Image URL" style="width: 100%; padding: 8px; border: 1px solid #ddd; border-radius: 5px; margin-bottom: 5px;">
            </div>
            <button type="button" onclick="addColorImageInput(this)" style="background: #27ae60; color: white; border: none; padding: 5px 10px; border-radius: 5px; cursor: pointer; font-size: 11px;">+ Add Image</button>
        </div>
    `;
...
window.addColorImageInput = function(button) {
    ...
    input.style.cssText = 'width: 100%; padding: 8px; border: 1px solid #ddd; border-radius: 5px; margin-bottom: 5px;';
...
window.addEditColorVariantInput = function(name = '', images = []) {
    ...
    colorGroup.innerHTML = `
        ...
        <div class="color-images-container" style="padding: 10px; background: #f8f9fa; border-radius: 5px;">
            <div class="edit-color-image-inputs">
                ${imagesHtml}
            </div>
            <button type="button" onclick="addEditColorImageInput(this)" style="background: #27ae60; color: white; border: none; padding: 5px 10px; border-radius: 5px; cursor: pointer; font-size: 11px;">+ Add Image</button>
        </div>
    `;
    container.appendChild(colorGroup);
};
