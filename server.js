...
app.post('/send-order-email', (req, res) => {
    ...
    const mailOptions = {
        from: '"FicoKart Orders" <ficokart.support@gmail.com>',
        to: adminEmails.join(','),
    ...
    console.log(`📤 Attempting to send email to: ${adminEmails.join(', ')}`);
    ...
    transporter.sendMail(mailOptions, (error, info) => {
        ...
        console.log(`✅ Success! Email sent to ${adminEmails.length} admins.`);
...
app.listen(PORT, () => {
    console.log(`✅ Backend Server is online and ready.`);
